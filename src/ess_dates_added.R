...
dates_added <- data.frame(
  cntry = c("DK", "ES", "HR", "IS", "LT", "LV", "PT", "SE", "SK"),
  essround = c(9, 9, 9, 9, 9, 9, 9, 9, 9),
  # manual imputation
  recent_election = as.Date(c("2015-06-18", "2019-11-10", "2016-09-11", "2017-10-28", "2016-10-09", "2018-10-06", "2015-10-04", "2018-09-09", "2016-03-05")),
  split_wave = rep(NA, 9),
  recent_election_split1 = as.Date(rep(NA, 9)),
  max_days_since_election_split1 = rep(NA, 9)
)
